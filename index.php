          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <div class="art-avatar">
                <a data-fancybox="avatar" data-no-swup href="img/profile.jpg" class="art-avatar-curtain">
            ...
            <div id="scrollbar2" class="art-scroll-frame">
              ...
              <div class="art-table p-15-15">
                ...
                <ul>
                  ...
                  <!-- city -->
                  <li>
                    <h6>City:</h6><span>Paranaque</span>
                  </li>
                  <!-- age -->
                  <li>
            ...
            <div class="art-ls-social">
              <!-- social link -->
              <a href="https://github.com/Topher-06" target="_blank"><i class="fab fa-github"></i></a>
              <!-- social link -->
              <a href="#." target="_blank"><i class="fab fa-twitter"></i></a>
              <a href="https://www.facebook.com/christopher.main.904/" target="_blank"><i class="fab fa-facebook"></i></a>
              <a href="https://www.instagram.com/t_0_p_h_e_r/" target="_blank"><i class="fab fa-instagram"></i></a>
            </div>
            <!-- sidebar social end -->
            ...
            <div id="scrollbar" class="art-scroll-frame">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6">
                    ...
                    <div class="art-a art-service-icon-box">
                      ...
                      <div class="art-service-ib-content">
                        <!-- title -->
                        <h5 class="mb-15">Android Developement</h5>
                        <!-- text -->
                        <div class="mb-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus esse commodi deserunt vitae, vero quasi! Veniam quaerat tenetur pariatur doloribus.</div>
                        <!-- button -->
                        <div class="art-buttons-frame"><a href="#" class="art-link art-color-link art-w-chevron">Let's Talk</a></div>
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <!-- col -->
                  <div class="col-lg-4 col-md-6 xCard">
                  ...
                  <div class="col-lg-4 col-md-6 xCard">
                    ...
                    <!-- service -->
                    <div class="art-a art-service-icon-box" style="background-image: url('img/project5.png'); background-size: 100% 100%;">
                      <!-- service content -->
                      <div class="art-service-ib-content">
                        <!-- title -->
                        <h5 class="mb-15">Covid Tracker App</h5>
                        <!-- text -->
                        <div class="mb-15"><br><br><br><br><br></div>
                        <!-- button -->
                        <div class="art-buttons-frame"><a href="https://m.apkpure.com/exploit-browser-beta/com.EliteCyberDevs.Hackbar#com.EliteCyberDevs.Hackbar-1" class="art-link art-color-link art-w-chevron">View</a></div>
